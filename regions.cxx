...
#include <ctype.h>
#if 10000*FL_MAJOR_VERSION + 100*FL_MINOR_VERSION + FL_PATCH_VERSION >= 10305
...
#ifdef WIN32
#define GBLOCKS_NAME "Gblocks.exe"
#elif defined(__APPLE__)
  const char  *GBLOCKS_NAME = (fl_mac_os_version >= 101400 ? "Gblocks_x86_64" : "Gblocks_ppc_i386");
#else
#define GBLOCKS_NAME "Gblocks"
#endif
  q = get_full_path(GBLOCKS_NAME);
