...
#if defined(__APPLE__)
#  ifdef __ppc__
          p = (char*)"phyml_3.0_universal";
#  else
          p = (char*)(fl_mac_os_version < 100800 ? "phyml_3.0_universal" : "PhyML-3.1_macOS-MountainLion");
#  endif // __ppc__
          if ((q = get_full_path(p)) == NULL) {
            fl_message("Warning: PhyML executable not found. Please, download the seaview macOS application again.");
            return;
          }
#else
